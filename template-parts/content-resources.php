...
<div class="butterflywebsiteresources container">
		 	...
		 	<div class="panel panel-default">
			    <div class="panel-heading" role="tab" id="headingOne">
			      <h4 class="panel-title">
			        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="true" aria-controls="collapse1"><img src="<?php echo get_template_directory_uri()?>/assets/resources/img/butterflywebsiteresources-add-remove-1.svg" class="more-less removeIcon svg"/> <?php if(get_field('question_faq_one')):?><?php the_field('question_faq_one');?><?php else:?>Question that needs an answer? #1<?php endif;?></a>
			      </h4>
			    </div>
    ...
    <div class="panel-heading" role="tab" id="headingTwo">
      <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-expanded="false" aria-controls="collapse2"><img src="<?php echo get_template_directory_uri()?>/assets/resources/img/butterflywebsiteresources-add-remove-1.svg" class="svg more-less addIcon"/> <?php if(get_field('question_faq_two')):?><?php the_field('question_faq_two');?><?php else:?>Question that needs an answer? #2<?php endif;?></a>
      </h4>
    </div>
    ...
    <div class="panel-heading" role="tab" id="headingThree">
      <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse3" aria-expanded="false" aria-controls="collapse3"><img src="<?php echo get_template_directory_uri()?>/assets/resources/img/butterflywebsiteresources-add-remove-1.svg" class="more-less addIcon svg"/> <?php if(get_field('question_faq_three')):?><?php the_field('question_faq_three');?><?php else:?>Question that needs an answer? #3<?php endif;?></a>
      </h4>
    </div>
