...
<head>
	...
	<meta name="theme-color" content="#2ce6ce">
	...
	<div data-spy="affix" data-offset-top="0" data-offset-bottom="0">
		<header id="masthead" class="container-fluid navbar-fixed-top">
			<div class="site-header">
				...
				<a href="#" data-toggle="modal" data-target="#myModal" class="menu-icon"><span class="menu-bar">PRODUCT <img src="<?php echo get_template_directory_uri()?>/assets/img/combined-shape.svg" class="menu-icon-Combined-Shape" alt=""></span></a>
			</div>	
		</header><!-- #masthead -->
	</div><!-- #affix -->
